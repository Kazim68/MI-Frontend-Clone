  ...
  return (
    <div className="preNav">
      <div>
        ...
        <a href="https://v12.mi.com/pk/phone/">Phone App</a> <span>|</span>
        <a href="https://v12.mi.com/pk/smart-home/">Smart Home</a> <span>|</span>
        <a href="https://v12.mi.com/pk/life-style/">LifeStyle</a> <span>|</span>
      </div>
      <div>
        <a href="https://buy.mi.com/pk/site/login?redirectUrl=https://www.mi.com/pk/">Sign In</a> <span>|</span>
        <a href="https://buy.mi.com/pk/site/login?redirectUrl=https://www.mi.com/pk/&scene=register">Sign Up</a> <span>|</span>
        <a href="https://corecart.pk/">{cart} Cart (0)</a>
      </div>
    </div>
  )
}
